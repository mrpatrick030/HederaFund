...
export default function Header(){
  ...
  useEffect(() => {
    ...
    return (
      ...
      <div className='text-center w-[100%] py-[0.3cm] text-[#fff] bg-[rgba(5,5,5,0.95)] headerdivforlarge' style={{boxShadow:"-1px 1px 1px 1px rgba(0,0,0,0.2)", zIndex:"999", position:"fixed", transition:"0.3s ease-in-out"}}>
      <Link href="/"><img src="images/logo1.png" width="40" style={{display:"inline-block"}} alt="" /></Link>
      <div className='ml-[1cm]' style={{display:"inline-block"}}>
      <Link href="/dashboard"><button className='ml-[1cm] menuitems'>Lend</button><img src="images/lending.png" width="25" alt="" className='ml-[0.2cm]' style={{display:"inline-block"}}/></Link>
      <Link href="/dashboard"><button className='ml-[1cm] menuitems'>Borrow</button><img src="images/borrowing.png" width="25" alt="" className='ml-[0.2cm]' style={{display:"inline-block"}}/></Link>
      </div>
      <div className='ml-[1.2cm]' style={{display:"inline-block"}}>
      <span className='text-[#fff] font-[600]'>DeFi, P2P lend/borrow on Hedera</span>
      <img src="images/hedera.svg" alt="" width="55" className='ml-[0.2cm] rounded-[100%] mt-[-0.1cm]' style={{display:"inline-block"}} />
      </div>
      ...
      <Link href="/"><img src="images/logo1.png" width="35" alt="" className='float-right' style={{display:"inline-block"}}/></Link>
      </div>) : 
      ...
      <div className='py-[0.3cm] px-[0.2cm] text-right' style={{boxShadow:"-2px 0px 5px 2px #000", display:"block"}}><img src="images/crossed.png" width="40" alt="" onClick={(e) => changemenubehaviour2(e)} className='cursor-pointer' style={{display:"inline-block"}} /></div>
      <div className='px-[0.5cm]'>
       ...
       <Link href="/" onClick={(e) => changemenubehaviour2(e)}><img src="images/logo1.png" width="40" alt="" style={{display:"inline-block"}}/></Link>
       <Link href="https://www.hedera.com/" onClick={(e) => changemenubehaviour2(e)}><img src="images/hedera.svg" width="55" alt="" className='ml-[0.5cm] rounded-[100%]' style={{display:"inline-block"}}/></Link>
       </div>
      </div>
      </div>
      </div>)
